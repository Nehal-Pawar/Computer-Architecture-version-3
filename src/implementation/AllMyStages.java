...
//                globals.setClockedProperty("branch_state_decode", GlobalData.BRANCH_STATE_NULL);
          ...
          //  if(oper0.hasFloatValue())            
            //oper0.setFloatValue(Float.intBitsToFloat(oper0.getValue())); 
          ...
          /*  if(src1.hasFloatValue())            
            	src1.setFloatValue(src1.getValue()); 
            if(src2.isFloat())            
            	src2.setFloatValue(src2.getValue());*/
