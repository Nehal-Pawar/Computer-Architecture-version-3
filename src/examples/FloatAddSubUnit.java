 ...
 * @author millerti
 */
public class FloatAddSubUnit extends FunctionalUnitBase {
    public FloatAddSubUnit(IModule parent, String name) {
        super(parent, name);
    }
...
//            super(parent, "in:Math");  // this would be fine too
        ...
        public void compute(Latch input, Latch output) {
            ...
            if (ins.getOpcode() == EnumOpcode.FSUB) {
            	float result = source1 - source2;
            	output.setResultFloatValue(result);
                }
            if (ins.getOpcode() == EnumOpcode.FCMP) {
            	float result = source1 - source2;
